    ...
    <section class="full main">
        ...
        <section class="form">
            ...
            <div class="full">
                ...
                <center>
                    <h3>Player 1, preencha os campos abaixo:</h3>
                </center>
            ...
            <div class="full">
                <div class="center">
                    ...
                    <form method="post" action="form2.php">
                        ...
                        <div class="full">
                            <input type="text" name="nome" class="tx" placeholder="Nome" required>
                        </div>

                        <div class="full">
                            <input type="text" name="canoa" class="tx" placeholder="Nome da Canoa" required>
                        </div>

                        <div class="full">
                            <br>
                            <label><h5>Posição inicial:</h5></label>
                            <select name="posicao" class="tx" required>
